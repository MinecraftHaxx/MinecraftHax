...
public class SolarisClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        // Listen for Insert key to toggle GUI
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            if (client.currentScreen == null && org.lwjgl.glfw.GLFW.glfwGetKey(client.getWindow().getHandle(), GLFW.GLFW_KEY_INSERT) == GLFW.GLFW_PRESS) {
                hudOpen = !hudOpen;
